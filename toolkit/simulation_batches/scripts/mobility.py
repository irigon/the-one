...
def extended_variable_list(d):
    l =  ['Group.router','Events1.size','Scenario.endTime','Events1.interval','PTW.beta', 'PTW.gamma', 'Group2.speed', 'Group2.waitTime', 'Group2.nrofHosts', 'Group2.active_window', 'Group2.adaptive_routing','Transit.restPeriod']
    return l
