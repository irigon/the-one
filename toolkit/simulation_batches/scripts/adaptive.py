...
def get_template():
    return "{}_router:{}_EventSize:{}_endTime:{}_Events1.interval:{}_beta:{}_gamma:{}_altGamma:{}_activeWindow:{}_adaptive:{}"
...
for scenario in SCENARIO_LIST:
    ...
    for entry in dict_list:
        ...
        variable_list = ['Group.router','Events1.size','Scenario.endTime','Events1.interval','PTWRouter.beta', 'PTWRouter.gamma', 'PTWRouter.altGamma', 'PTWRouter.active_window', 'PTWRouter.adaptive_routing']
