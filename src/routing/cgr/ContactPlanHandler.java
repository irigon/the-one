...
public class ContactPlanHandler {
	...
	private static boolean write_offline_nodes;
    ...
    /**
     * Store contacts for this host
     */
    public void prepare_to_write(World world) {
    	for (DTNHost h: world.getHosts()) {
    		finish_contactplan(h);
    		save_contacts(h);
    	}
    }
}
